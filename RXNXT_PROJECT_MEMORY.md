...
1. `DATABASE_URL`: Must point to a live PostgreSQL database (e.g., Supabase, Neon, AWS RDS). *Note: The local `rxnxt.db` SQLite file is no longer used for production.*
